  ...
  return (
    <div>
      ...
      <form onSubmit={handleLogin}>
        <label className='formConnexion'>
          Nom d'utilisateur:
          <input className='inputConnexion' type="text" value={username} onChange={handleUsernameChange} />
        </label>
        <label className='formConnexion'>
          Mot de passe:
          <input className='inputConnexion' type="password" value={password} onChange={handlePasswordChange} />
        </label>
